...
gTextures = {
    ...
    ['backgrounds'] = love.graphics.newImage('graphics/londonBackground.png'),
    ['green-alien'] = love.graphics.newImage('graphics/bill.png'),
...
gFrames = {
    ...
    ['green-alien'] = GenerateQuads(gTextures['green-alien'], 14, 28),
